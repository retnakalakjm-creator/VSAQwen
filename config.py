...
EFFORT_EVIDENCE_WEIGHTS = {
    EvidenceCode.EFFORT_GT_RESULT: 0.00,
    EvidenceCode.RESULT_GT_EFFORT: 0.00,
    EvidenceCode.ABSORPTION: 0.00,
}
...
SHAKEOUT_TEST_FORWARD_WINDOW = 15
SHAKEOUT_TEST_LOOKAHEAD = SHAKEOUT_TEST_FORWARD_WINDOW  # Backward-compatible alias.
...
SHAKEOUT_RECOVERY_FORWARD_WINDOW = 5
SHAKEOUT_RECOVERY_LOOKAHEAD = SHAKEOUT_RECOVERY_FORWARD_WINDOW  # Backward-compatible alias.
...
PRODUCTION_DOWNLOAD_PERIOD = "5y"
DEFAULT_PERIOD = PRODUCTION_DOWNLOAD_PERIOD
