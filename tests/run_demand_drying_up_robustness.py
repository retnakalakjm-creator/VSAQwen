...
from matched_demand_drying_up_audit import build_matches, _scan_cases
from robustness_demand_drying_up_audit import summarize
from run_nse_increasing_demand_universe_audit import SYMBOLS


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Bootstrap robustness audit for DEMAND_DRYING_UP matched pairs."
    )
    ...
    print("=== DEMAND_DRYING_UP ROBUSTNESS AUDIT ===")
