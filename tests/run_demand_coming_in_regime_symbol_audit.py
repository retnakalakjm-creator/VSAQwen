...
from coverage_demand_coming_in_audit import summarize_by_symbol


def main() -> None:
    parser = argparse.ArgumentParser(description="Per-symbol concentration audit for DEMAND_COMING_IN significant regimes.")
    ...
    print("=== DEMAND_COMING_IN SIGNIFICANT-REGIME SYMBOL AUDIT ===")
    ...
    print()
    print("* symbol/horizon bucket meets minimum-case threshold")
    if skipped:
        print()
        print("=== SKIPPED ===")
